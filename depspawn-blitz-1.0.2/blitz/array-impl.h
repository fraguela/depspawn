...
#define DEPSPAWN_BLITZ

  //Only for usage for DepSpawn in Array<P_numtype, N_rank>::constructSlice
  const GeneralArrayStorage<N_rank>& storage() const { return storage_; }
